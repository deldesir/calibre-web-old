...
$(document).ready(function() {
    ...
    // Function to validate YouTube URL (same as before)
    function isValidYoutubeURL(url) {
        var youtubeURLPattern = /^(https?:\/\/)?(www\.)?(youtube\.com\/watch\?v=|youtu\.be\/|youtube\.com\/playlist\?list=|youtube\.com\/channel\/)([a-zA-Z0-9_-]{11}|[a-zA-Z0-9_-]{34})/;
